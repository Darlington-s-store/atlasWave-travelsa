      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <div className="text-[12px] text-muted-foreground bg-muted/40 px-3 py-1.5 rounded-lg border border-border/60">
            Bookings made by guests appear here for management.
          </div>
        </div>
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-[13px] text-muted-foreground mt-1">Flight bookings made on the website will appear here for you to confirm, edit, or cancel.</p>
              </div>
            ) : (
              <Table>
                <TableHeader>
