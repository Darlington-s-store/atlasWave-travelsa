    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-[hsl(210,20%,97%)]">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 md:h-16 flex items-center justify-between border-b border-border bg-background px-3 sm:px-4 md:px-6 sticky top-0 z-30">
            <div className="flex items-center gap-2 md:gap-3 min-w-0">
              ...
              <div className="relative hidden md:block">
                ...
                <Input
                  ...
                  className="pl-9 w-[280px] lg:w-[320px] h-9 bg-muted/50 border-transparent focus:border-border text-sm"
                />
              </div>
            </div>
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              <Button variant="ghost" size="icon" className="relative h-8 w-8 md:h-9 md:w-9">
                ...
                <span className="absolute top-1 right-1 md:top-1.5 md:right-1.5 w-2 h-2 rounded-full bg-destructive" />
              </Button>
          ...
          <main className="flex-1 p-3 sm:p-5 md:p-7 lg:p-8 overflow-auto">
            {children}
          </main>
          <footer className="py-3 px-4 md:px-6 border-t border-border bg-background">
