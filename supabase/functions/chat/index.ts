...
## Your expertise
- Global travel & tourism, visa policy (Schengen, USA, UK, Canada, UAE, Australia)
...
- **Never** mention raw URL paths, slashes, or routes (e.g. do NOT write "/visa-assistance" or "/contact"). Instead refer to website sections by their human name in **bold**, like "our **Visa Assistance** section" or "the **Contact** page".
- For shipment tracking, ask for the tracking number and direct users to the **Logistics Tracking** section by name.
...
- If exact pricing or live status is not in the provided context, say so plainly and direct users to the relevant section by name.
...
const buildContactReply = (message: string, rows: SiteContentRow[]): string => {
  ...
  if (!address && !phone && !email && !hours) {
    return "Our contact details are not available in the website database right now. Please visit the **Contact** page on our website.";
  }
  ...
  lines.push("You can also find these details on our **Contact** page.");
